    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://insightfy-dr.sentry.io/issues/?project=4510325009547264">Issues Page</a>.
        ...
        <button
          type="button"
          onClick={() => {
            // Intencional: dispara um erro de referência para testar o Sentry
            // Chama uma função inexistente para gerar um ReferenceError
