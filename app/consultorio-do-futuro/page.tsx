...
import { CONSULTORIO_FUTURO_COURSE, PALESTRA_IA_EVENT } from "@/lib/cakto"
...
export default function ConsultorioDoFuturoPage() {
    ...
    return (
        <main className="relative min-h-screen bg-[#0a0f1a]">
            ...
            {/* Event Banner */}
            <div className="relative z-20 w-full bg-gradient-to-r from-violet-600 to-emerald-600 text-white text-center py-3 px-4">
                <Link href="/palestra-ia" className="flex items-center justify-center gap-2 text-sm sm:text-base font-medium hover:underline">
                    <Sparkles className="w-4 h-4" />
                    <span>Palestra Online Hoje as 20h &mdash; Consultorio do Futuro na Odontologia (IA) &mdash; Certificado de {PALESTRA_IA_EVENT.hours}h</span>
