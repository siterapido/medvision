...
# Rebranding de Degradês: De IA Clichê para Premium Tech Plan

> Substituir os degradês clichês (azul/roxo) por uma estética "Premium Tech" (azul para branco/prata) em toda a landing page.
...
- **Total symbols discovered:** 24137
...
- **Entry points:** lib/supabase/server.ts, components/research/index.ts, components/agno-chat/index.ts (+17 more)

### Key Components
**Core Classes:**
- `RoutingTestCase` — /Users/marcosalexandre/v0-odonto-gpt-ui/odonto-gpt-agno-service/test_routing_system.py:165
- `RoutingTester` — /Users/marcosalexandre/v0-odonto-gpt-ui/odonto-gpt-agno-service/test_routing_system.py:183
- `StreamEventProcessor` — /Users/marcosalexandre/v0-odonto-gpt-ui/odonto-gpt-agno-service/app/services/stream_processor.py:9
- `ZApiConfig` — /Users/marcosalexandre/v0-odonto-gpt-ui/odonto-gpt-agno-service/app/tools/whatsapp.py:17
- `ZApiMessage` — /Users/marcosalexandre/v0-odonto-gpt-ui/odonto-gpt-agno-service/app/tools/whatsapp.py:25

**Key Interfaces:**
- `NotificationTemplate` — /Users/marcosalexandre/v0-odonto-gpt-ui/lib/notifications.ts:5
- `AgentDetails` — /Users/marcosalexandre/v0-odonto-gpt-ui/lib/agno.ts:68
- `ToolCall` — /Users/marcosalexandre/v0-odonto-gpt-ui/lib/agno.ts:79
- `RunResponseChunk` — /Users/marcosalexandre/v0-odonto-gpt-ui/lib/agno.ts:88
- `ChatMessage` — /Users/marcosalexandre/v0-odonto-gpt-ui/lib/agno.ts:113
## Agent Lineup
