...
# Plano de Otimização: Roteamento Inteligente & Performance Plan

> Melhoria do sistema de roteamento (migração para busca semântica) e otimização de performance (caching, streaming especulativo) para reduzir latência.
...
- **Total symbols discovered:** 21247
- **Architecture layers:** Config, Controllers, Components, Utils, Services, Models
- **Detected patterns:** Factory, Singleton, Controller, Builder, Observer
...
- `RoutingTestCase` — /Users/marcosalexandre/projetos/odontogptweb/odonto-gpt-agno-service/test_routing_system.py:165
- `RoutingTester` — /Users/marcosalexandre/projetos/odontogptweb/odonto-gpt-agno-service/test_routing_system.py:183
