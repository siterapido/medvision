...
# Refinamento Minimalista Tech - Correção Tema Claro Plan

> Correção total para tema claro na página de pesquisas e chat lateral. Eliminação de fundos escuros residuais, correção de contraste de texto e padronização minimalista (azul claro/cinza).
...
- **Total symbols discovered:** 23895
...
- **Entry points:** lib/supabase/server.ts, components/research/index.ts, components/dashboard/index.ts (+18 more)

### Key Components
**Core Classes:**
- `MockDb` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/scripts/test_perplexity_research.py:46
- `MockDb` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/scripts/test_artifact_generation.py:25
- `RoutingTestCase` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/odonto-gpt-agno-service/test_routing_system.py:64
- `RoutingTester` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/odonto-gpt-agno-service/test_routing_system.py:82
- `TestSummaryAgent` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/odonto-gpt-agno-service/tests/test_summary_agent_mock.py:16
...
- `AgentDetails` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/lib/agno.ts:68
- `ToolCall` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/lib/agno.ts:79
- `RunResponseChunk` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/lib/agno.ts:88
- `ChatMessage` — /Users/marcosalexandre/Library/CloudStorage/GoogleDrive-marckexpert1@gmail.com/Meu Drive/Mac_Sync/Projetos/v0-odonto-gpt-ui/lib/agno.ts:113
## Agent Lineup
