...
# Biblioteca Interativa com Formulários de Artefatos Plan

> Reformular a biblioteca para gerar artefatos via formulários interativos configuráveis, removendo geração via chat. Interface minimalista com animações da LP.
