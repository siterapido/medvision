...
export function MobileNav({ user }: { user: any }) {
    ...
    return (
        <>
            ...
            <div className="fixed top-6 left-1/2 -translate-x-1/2 z-50 lg:hidden w-auto max-w-[95%]">
                <nav className="bg-background/80 backdrop-blur-2xl border border-white/20 dark:border-white/10 px-3 py-2 flex items-center gap-3 rounded-[2rem] shadow-lg shadow-black/5">
                    ...
                    <button
                        ...
                        className={cn(
                            "flex items-center justify-center w-9 h-9 rounded-full transition-all duration-300 bg-muted/50 hover:bg-muted",
